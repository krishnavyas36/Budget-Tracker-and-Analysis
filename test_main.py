...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        self.style.set_theme("scidgrey")  # Set dark theme

        # Set font color to white for better visibility (optional)
        self.style.configure("TLabel", foreground="white")  # White text for labels
        self.style.configure("TButton", foreground="white")  # White text for buttons
...
class SecondWindow(tk.Toplevel):
    def __init__(self, main_app):
        ...
        # Style elements for second window
        self.style = ThemedStyle(self)
        self.style.set_theme("scidgrey")  # Set dark theme
